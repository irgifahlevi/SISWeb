...
@section('content')
@include('AdminView.GaleriContent.search')
            ...
            <div class="card-body">
              <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    @php
                        $nomor = 1 + (($galeri->currentPage() - 1) * $galeri->perPage());
                    @endphp
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="align-items-center">
                            <img src="{{ asset('storage/galeri/' . $item->gambar) }}" alt="{{ $item->gambar }}" class="w-px-40 h-auto rounded-circle" />
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <button class="dropdown-item" type="button" id="edit-galeri" data-id="{{$item->id}}">
                ...
                <div class="mt-3">
                  <!-- {{-- {{ $dataBarang->links() }} --}} -->
                  {!! $galeri->appends(Request::except('page'))->render() !!}
                </div>
              </div>
            </div>
          </div>
        ...
        @else
          <div class="card">
            <div class="d-flex align-items-end row">
              <div class="col-sm-7">
                <div class="card-body">
                  <h5 class="card-title text-primary">Belum ada data galeri! 😞</h5>
                  <button class="btn btn-sm btn-outline-primary" type="button" id="add-galeri">Tambah data sekarang</button>
                </div>
              </div>
      ...
      Swal.fire({
        ...
        if (result.isConfirmed){
          $.ajax({
            ...
            url: '{{ route('galeri-content.destroy', [':id']) }}'.replace(':id', id),
            type: 'DELETE',
