        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="text-muted">
                            <h5 class="font-size-16 mb-3">Nama calon siswa : {{$data->CalonSiswaPendaftaran->nama_lengkap}}</h5>
                            <p class="mb-1">NIK : {{$data->CalonSiswaPendaftaran->nik}}</p>
                            <p class="mb-1">Alamat : {{$data->CalonSiswaPendaftaran->alamat}}</p>
                            <p>
                                No telepon :
                                @if ($data->CalonSiswaPendaftaran->no_telepon)
                                    {{formatNoTelpon($data->CalonSiswaPendaftaran->no_telepon)}}
                                @endif
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="text-muted text-sm-end">
                            <div>
                                <h5 class="font-size-15 mb-1">Kode pendaftaran:</h5>
