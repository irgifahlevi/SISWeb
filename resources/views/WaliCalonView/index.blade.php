    ...
    <div class="row justify-content-center">
      <div class="col-md-12">
        ...
        @if ($data != null)
          {{-- Tabel --}}
          <div class="card mb-4">
            <h5 class="card-header">Biaya pendaftaran</h5>
            <div class="card-body">
              ...
              <button type="submit" class="btn btn-success deactivate-account mt-3" id="form-data-siswa" data-id="{{$info_pendaftaran_id}}">Daftar sekarang</button>
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            ...
                            @elseif($item->status_seleksi == 'tidak_lolos')
